...
namespace HotelManager
{
    public partial class fRoomType : Form
    {
        ...
        private void AddNewRoomTypebtn_Click(object sender, EventArgs e)
        {
            fAddRoomType addRoomTypeForm = new fAddRoomType();
            addRoomTypeForm.RoomTypeAdded += AddRoomTypeForm_RoomTypeAdded;
            addRoomTypeForm.ShowDialog();
        }

        private void AddRoomTypeForm_RoomTypeAdded()
        {
            LoadFullRoomType(GetFullRoomType());
        }
        ...
        private void TxbSearch_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            else if (e.KeyChar == 27 && btnCancel.Visible == true)
